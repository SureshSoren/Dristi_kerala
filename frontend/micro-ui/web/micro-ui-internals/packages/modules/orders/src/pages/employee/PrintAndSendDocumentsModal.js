...
import { printAndSendDocumentsConfig } from '../../../../../../../../../micro-ui/web/micro-ui-internals/packages/modules/orders/src/configs/EpostFormConfigs';
import { FormComposerV2 } from '@egovernments/digit-ui-react-components';
import { Urls } from '../../../../../../../../../micro-ui/web/micro-ui-internals/packages/modules/dristi/src/hooks';
    ...
    const Document = () => (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_5177_71858)">
                <path d="M14 2H6C4.9 2 4.01 2.9 4.01 4L4 20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2ZM16 18H8V16H16V18ZM16 14H8V12H16V14ZM13 9V3.5L18.5 9H13Z" fill="#505A5F" />
            </g>
            <defs>
...
return (
    <Modal
        ...
        actionSaveOnSubmit={() => {setForm(tempForm); setStepper(stepper + 1);}}
        ...
        <div style={{ padding: '16px', marginTop: "1rem" }}>
            <div style={{ backgroundColor: "#F7F5F3", padding: "1rem" }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                    ...
                    <span>₹575</span>
                    <span style={clickableTextStyle} onClick={() => console.log("View Details clicked")}>{t("View Details")}</span>
                </div>
