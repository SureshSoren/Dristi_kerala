      ...
      <div className="comment-details">
        ...
        {comment?.chatDocument && (
          <div
            ...
            onClick={() => {
              window.open(`/filestore/v1/files/id?tenantId=kl&fileStoreId=${comment.chatDocument}`, "_blank", "noopener,noreferrer");
            }}
          >
            <FileIcon />
            <span style={{ fontWeight: "bold" }}>{comment.chatDocumentName || "Attached File"}</span>
          </div>
        )}
      </div>
    </div>
